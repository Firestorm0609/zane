...
PAPER_POSITION_SIZE_USD    = _float("PAPER_POSITION_SIZE_USD", 10.0)
PAPER_POLL_INTERVAL_SEC    = _int("PAPER_POLL_INTERVAL_SEC", 60)
PAPER_STATS_LOOKBACK       = _int("PAPER_STATS_LOOKBACK", 1000)
PAPER_STARTING_BALANCE_USD = _float("PAPER_STARTING_BALANCE_USD", 50.0)
...
PAPER_SLIPPAGE_PCT         = _float("PAPER_SLIPPAGE_PCT", 20.0)
